...
public class IntervalExerciseGenerator implements ExerciseGenerator {
    ...
    public GeneratedExercise generate(int difficulty) {
        ...
        String description   = "Toca este intervalo com raiz em " + Note.fromMidi(low).getDisplayName();
        ...
        return new GeneratedExercise(
            ...
            description, hint, new int[]{low, high}
        );
    }
    ...
    public GeneratedExercise fromStored(String questionJson, String correctAnswer, int difficulty) {
        ...
        try {
            ...
            int noteA = q.notes()[0];
            int noteB = q.notes()[1];
            String description = "Toca este intervalo com raiz em " + Note.fromMidi(noteA).getDisplayName();
